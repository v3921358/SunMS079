...
public class MapleItemInformationProvider {
    ...
    protected final Map<Integer, Integer> ExpCache = new HashMap();
    ...
    public void runItems() {
        ...
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            for (Entry<Integer, ItemInformation> entry : dataCache.entrySet()) {
             ...
             System.err.println("runItems" + ex);
    ...
    public short getPetFlagInfo(int itemId) {
        if (this.petFlagInfo.containsKey(itemId)) {
            return ((Short) this.petFlagInfo.get(itemId));
        }
        short flag = 0;
        if (itemId / 10000 != 500) {
            return flag;
