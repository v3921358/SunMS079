...
public class ItemMakerFactory {
    ...
    protected ItemMakerFactory() {
        ...
        final MapleData info = MapleDataProviderFactory.getDataProvider(new File((System.getProperty("wzpath") != null ? System.getProperty("wzpath") : "") + "wz/Etc.wz")).getData("ItemMake.img");
