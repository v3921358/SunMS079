...
public class MapleSnowball extends MapleEvent {
    ...
    public static class MapleSnowballs {
        ...
        public static final void hitSnowball(final MapleCharacter chr) {
            /*
             * TEAM 0 - bottom snowball 1 - top snowball 2 - bottom snowman 3 -
             * top snowman
             *
             * MESSAGE 0 - start 1 - past stage 1 2 - past stage 2 3 - past
             * stage 3 4 - unhittable 5 - rehittable
             *
             * ROLL 0 - start/normal 1 - roll 2 - bottom invis 3 - top invis 4 -
             * move
             */
                ...
                if (!snowman) {
                    ...
                    if (damage == 0) {
                        ...
                        if (ball.getPosition() == 255 || ball.getPosition() == 511 || ball.getPosition() == 767) { // Going to stage
                            ...
                            chr.getMap().broadcastMessage(CWvsContext.broadcastMsg(6, "[恭喜]" + (team == 0 ? "蓝队" : "红队") + " 赢得胜利!"));
        ...
        /*
         * if (mapData.getChildByPath("snowBall") != null) { <imgdir
         * name="snowBall"> <imgdir name="0"> <int name="y" value="155"/>
         * <string name="portal" value="st00"/> <string name="snowBall"
         * value="Map/Obj/event.img/snowyRock/snowball/0"/> <string
         * name="snowMan" value="Map/Obj/event.img/snowyRock/snowball/1"/>
         * </imgdir> <imgdir name="1"> <int name="y" value="-84"/> <string
         * name="portal" value="st01"/> <string name="snowBall"
         * value="Map/Obj/event.img/snowyRock/snowball/0"/> <string
         * name="snowMan" value="Map/Obj/event.img/snowyRock/snowball/1"/>
         * </imgdir> <int name="x" value="-440"/> <int name="x0" value="400"/>
         * <int name="xMin" value="-60"/> <int name="xMax" value="900"/> <int
         * name="dx" value="3"/> <string name="damageSnowBall" value="10"/> <int
         * name="damageSnowMan0" value="15"/> <int name="damageSnowMan1"
         * value="45"/> <int name="recoveryAmount" value="400"/> <int
         * name="snowManHP" value="7500"/> <int name="snowManWait"
         * value="10000"/> <int name="speed" value="150"/> <int name="section1"
         * value="45"/> <int name="section2" value="290"/> <int name="section3"
         * value="560"/> </imgdir> }
         */
    }
}
