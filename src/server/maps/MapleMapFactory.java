...
public class MapleMapFactory {
     ...
     * 屏蔽某些NPC.
     */
    private final Map<Integer, Integer> DeStorynpc = new HashMap<Integer, Integer>() {
//        { // 20/8/16 来自ez：暂时注释掉，这个功能不用。
//            String[] scripts = ServerConfig.killnpc.split(",");
//            for (final String script : scripts) {
//                if (!script.equals("")) {
//                    int npcid = Integer.parseInt(script);
//                    put(npcid, 0);
//                }
//            }
//        }
...
//        { // 20/8/16, 来自ez: 此功能暂时不需要。
//            String[] scripts = ServerConfig.pbdt.split(",");
//            for (final String script : scripts) {
//                if (!script.equals("")) {
//                    int mapid = Integer.parseInt(script);
//                    put(mapid, 0);
//                }
//            }
