 ...
 */
public class SunMS extends javax.swing.JFrame {

    private static SunMS instance = new SunMS();

    /**
     * Creates new form SunMS
     */
    public static final SunMS getInstance() {
        return instance;
    }
    ...
    public SunMS() {
        ...
        setTitle("yxhMS管理工具    服务端版本为：Ver.0.79");
        initComponents();
    }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        try {
            ...
            Logger.getLogger(SunMS.class.getName()).log(Level.SEVERE, null, ex);
        }
            ...
            if (ts == null && (t == null || !t.isAlive())) {
                ...
                ts = EventTimer.getInstance().register(new Runnable() {
                    ...
                    public void run() {
                        ...
                        World.Broadcast.broadcastMessage(CWvsContext.serverNotice(0, "服务器將在 " + minutesLeft + "分钟后关闭. 请尽快关闭雇佣商人安全下线."));
                    ...
                    if (mch.getName().equals(名字)) {
                        if (数量 >= 0) {
                            ...
                            if (type.equals(MapleInventoryType.EQUIP) && !GameConstants.isThrowingStar(物品ID) && !GameConstants.isBullet(物品ID)
                                ...
                                MapleInventoryManipulator.addById(mch.getClient(), 物品ID, (short) 数量, "", null, 给予时间, false, "");
                            }
                        } else {
    ...
    private void FixAcLogged() {
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            try (PreparedStatement ps = con.prepareStatement("UPDATE accounts SET loggedin = 0 WHERE name = " + jTextField23.getText())) {
                ps.executeUpdate();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SunMS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
