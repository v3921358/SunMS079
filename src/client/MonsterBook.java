...
public class MonsterBook implements Serializable {
    ...
    public final void saveCards(Connection con, int charid) throws SQLException {
    ...
    public final void addCard(final MapleClient c, final int cardid) {
        ...
        if (cards.containsKey(cardid)) {
            ...
            if (levels > 4) {
                ...
                c.getSession().write(MonsterBookPacket.addCard(false, cardid, levels + 1));
    ...
    public boolean hasCard(int cardid) {
        return cards == null ? false : cards.containsKey(cardid);
    }
