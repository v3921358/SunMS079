...
function action(mode, type, selection) {
	...
	if (sel == 2 || sel == 4) {
		...
		if ((cm.getMeso() < cost) || (!cm.haveItem(oldWepId,1)) || (!cm.haveItem(4001126,leaves))) {
		    ...
		    status = 2;
		    cm.sendSimple("It appears that you have a #rStimulator#k for this级武器. Would you like to create the级武器 with or without the #rStimulator#k? If you create without the #rStimulator#k, the item will always be #baverage#k. If you do create it with the #rStimulator#k, the item has a random chance of being #blower#k or #bhigher#k than average.\r\n#b#L20#Create级武器 WITH Stimulator#l\r\n#L21#Create级武器 WITHOUT Stimulator#l#k");
		}
	    }
	} else if (sel == 0 || sel == 1) {
