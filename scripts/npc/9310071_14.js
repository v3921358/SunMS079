...
//			if(cm.getLevel() >= 51){
								if(cm.getLevel() >= 31 && cm.getLevel() <= 50){
		cm.openNpc(9310071, 4);
		}else{			
				cm.sendOk("你等级需达到31-50级范围内!");
				cm.dispose();
			}
		} else if (selection == 5) {
	if(cm.getLevel() >= 10){
