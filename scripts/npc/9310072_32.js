...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112769#B级（四维+7 攻击+5 魔力+8 HP+300）\r\n      需要以下材料:\r\n ";
			text +="     请先把#v1112770#卸下放在背包里\r\n";
			text +="  #v4011002#15个 #v4021000#15个 #v4021001#15个 #v4005000#8个\r\n";
			text +="  #v4021008#10个  #v4005004#5个 #v4021009#8个 #v4011007#8个 #v4003000#500个 \r\n";
			text +="  #v4031560#25个 #v4031559#15个  #v4031561#10个 #v4032391#8个 #v4032392#8个\r\n";
            ...
            if (cm.haveItem(1112770, 1) && cm.haveItem(4000021, 100) && cm.haveItem(4000030, 50) && cm.haveItem(4011002, 15) && cm.haveItem(4021000, 15) && cm.haveItem(4021001, 15) && cm.haveItem(4005000, 5) && cm.haveItem(4021008, 10) && cm.haveItem(4005004, 5) && cm.haveItem(4021009, 8) && cm.haveItem(4011007, 8) && cm.haveItem(4003000, 500) && cm.haveItem(4031560, 25) && cm.haveItem(4031559, 15) && cm.haveItem(4031561, 10) && cm.haveItem(4032391, 8) && cm.haveItem(4032392, 8) && cm.getMeso() >=2800000) {
                cm.gainItem(1112770,-1);
				cm.gainItem(4000021,-100);
				cm.gainItem(4000030,-50);
				cm.gainItem(4011002,-15);
				cm.gainItem(4021000,-15);
				cm.gainItem(4021001,-15);
				cm.gainItem(4005000,-8);
		...
		var type = ii.getInventoryType(1112769); //获得装备的类形
		var toDrop = ii.randomizeStats(ii.getEquipById(1112769)).copy(); // 生成一个Equip类
		//toDrop. setFlag(1);//上锁
		toDrop. setStr(7);//给力量
		toDrop. setDex(7);//给敏捷 
		toDrop. setInt(7);//给智力
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
                ...
                cm.sendOk("合成失败！材料不足！#v1113164#*1个 #v4001266#*50个 #v4000487#*50个 #v4031559#*5个 #v4003002#*5个 #v4003003#*5个 #v4000463#*1个 #v4021000#*10个 #v4021002#*10个 #v4021003#*10个 #v4021004#*10个 #v4021006#*10个 500万金币");
                cm.dispose();
            }
        } else if (selection == 3) {
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
                ...
                cm.sendOk("合成失败！材料不足！#v1113165#*1个 #v4001266#*100个 #v4000487#*100个 #v4031559#*8个 #v4003002#*10个 #v4003003#*10个 #v4031561#*5个 #v4000463#*7个 #v4021001#*10个 #v4021002#*10个 #v4021003#*10个 #v4021005#*10个 #v4021006#*10个 #v4021008#*10个+ 1000万金币");
                cm.dispose();
            }
        } else if (selection == 4) {
            if (cm.haveItem(1113166, 1) && cm.haveItem(4001266, 200) && cm.haveItem(4000487, 200) && cm.haveItem(4003002, 20) && cm.haveItem(4003003, 20) && cm.haveItem(4001006, 50) && cm.haveItem(4031561, 10) && cm.haveItem(4031560, 10) && cm.haveItem(4021000, 10) && cm.haveItem(4021001, 10) && cm.haveItem(4021010, 2) && cm.haveItem(4000463, 5) && cm.getMeso() >=10000000) {
                ...
                cm.sendOk("合成失败！材料不足！#v1113166#*1个 #v4001266#*200个 #v4000487#200个 #v4003002#20个 #v4003003#*20个 #v4001006#*50个 #v4031561#*10个 #v4031560#*10个 #v4021000#*10个 #v4021001#*10个 #v4021010#*2个 #v4000463#*5个+ 1000万金币");
                cm.dispose();
            }
        } else if (selection == 5) {
            if (cm.haveItem(1113167, 1) && cm.haveItem(4001266, 700) && cm.haveItem(4000487, 700) && cm.haveItem(4001006, 100) && cm.haveItem(4031561, 20) && cm.haveItem(4031560, 20) && cm.haveItem(4021000, 20) && cm.haveItem(4021001, 20) && cm.haveItem(4021010, 5) && cm.haveItem(4000257, 10) && cm.haveItem(4000463, 10) && cm.getMeso() >=30000000) {
                ...
                cm.sendOk("合成失败！材料不足！#v1113167#*1个 #v4001266#*300个 #v4000487#*300个 #v4001006#*100个 #v4031561#*20个 #v4031560#*20个 #v4021000#*20个 #v4021001#*20个 #v4021010#*5个 #v4000257#*10个 #v4000463#*10个+ 3000万金币");
                cm.dispose();
            }
        } else if (selection == 6) {
