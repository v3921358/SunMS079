...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#r需要材料#k 30张#v4002000#,30张#v4002001#,20张#v4002002#  和 #v4005004#x2 \r\n\r\n"//1
            text += "#L1#兑换#v1112445##z1112445# #l\r\n\r\n\r\n"//1
			text += "#b该戒指只能兑换一次,多次兑换获取不了,丢弃可以重新兑换#k"//1
		   ...
		   cm.dispose();
           	   ...
           	   if (cm.haveItem(4002000, 30)&&cm.haveItem(4002001, 30)&&cm.haveItem(4002002, 20)&&cm.haveItem(4005004, 2)) { 
                   cm.gainItem(4002001,-30);
				   cm.gainItem(4002000,-30);
				   cm.gainItem(4002002,-20);
				   cm.gainItem(4005004,-2);
                   cm.gainItem(1112445,1, true);
                   cm.sendOk("兑换成功!");
