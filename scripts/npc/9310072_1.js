...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "      #r制作#v1112793#（四维+1）需要以下材料:\r\n\r\n";
			text +="  #v4011000#3个   #v4011001#3个  #v4011002#3个   #v4011003#3个  #v4011004#3个\r\n";
			text +="  #v4011005#3个   #v4011006#3个   #v4031561#3个   #v4031560#3个   #v4031559#3个\r\n\r\n";
			text +="                  合成费用：1,000,000金币（一百万）\r\n";
			text += "                                    #L1##r我要合成\r\n";
			
            cm.sendSimple(text);
        } else if (selection == 1) {
            if (cm.haveItem(4011000, 3) && cm.haveItem(4011001, 3) && cm.haveItem(4011002, 3) && cm.haveItem(4011003, 3) && cm.haveItem(4011004, 3) && cm.haveItem(4011005, 3) && cm.haveItem(4011006, 3) && cm.haveItem(4031561, 3) && cm.haveItem(4031560, 3) && cm.haveItem(4031559, 3) &&cm.getMeso() >=1000000) {
                cm.gainItem(4011000,-3);
                cm.gainItem(4011001,-3);
                cm.gainItem(4011002,-3);
                cm.gainItem(4011003,-3);
                cm.gainItem(4011004,-3);
                cm.gainItem(4011005,-3);
                cm.gainItem(4011006,-3);
                cm.gainItem(4031561,-3);
                cm.gainItem(4031560,-3);
                cm.gainItem(4031559,-3);
                cm.gainMeso(-1000000);
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
            ...
            if (cm.haveItem(1113164, 1) && cm.haveItem(4001266, 50) && cm.haveItem(4000487, 50) && cm.haveItem(4031559, 5) && cm.haveItem(4003002, 5) && cm.haveItem(4003003, 5) && cm.haveItem(4000463, 1) && cm.haveItem(4011000, 10) && cm.haveItem(4011002, 10) && cm.haveItem(4011003, 10) && cm.haveItem(4011004, 10) && cm.haveItem(4011006, 10) && cm.getMeso() >=5000000) {
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
                ...
                cm.sendOk("合成失败！材料不足！#v1113164#*1个 #v4001266#*50个 #v4000487#*50个 #v4031559#*5个 #v4003002#*5个 #v4003003#*5个 #v4000463#*1个 #v4011000#*10个 #v4011002#*10个 #v4011003#*10个 #v4011004#*10个 #v4011006#*10个 500万金币");
                cm.dispose();
            }
        } else if (selection == 3) {
            if (cm.haveItem(1113165, 1) && cm.haveItem(4001266, 100) && cm.haveItem(4000487, 100) && cm.haveItem(4031559, 8) && cm.haveItem(4003002, 10) && cm.haveItem(4003003, 10) && cm.haveItem(4031561, 5) && cm.haveItem(4000463, 3) && cm.haveItem(4021001, 10) && cm.haveItem(4021002, 10) && cm.haveItem(4021003, 10) && cm.haveItem(4021005, 10) && cm.haveItem(4021006, 10) && cm.haveItem(4021008, 10) &&cm.getMeso() >=10000000) {
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
                ...
                cm.sendOk("合成失败！材料不足！#v1113165#*1个 #v4001266#*100个 #v4000487#*100个 #v4031559#*8个 #v4003002#*10个 #v4003003#*10个 #v4031561#*5个 #v4000463#*3个 #v4021001#*10个 #v4021002#*10个 #v4021003#*10个 #v4021005#*10个 #v4021006#*10个 #v4021008#*10个+ 1000万金币");
                cm.dispose();
            }
        } else if (selection == 4) {
            if (cm.haveItem(1113166, 1) && cm.haveItem(4001266, 200) && cm.haveItem(4000487, 200) && cm.haveItem(4003002, 20) && cm.haveItem(4003003, 20) && cm.haveItem(4001006, 50) && cm.haveItem(4031561, 10) && cm.haveItem(4031560, 10) && cm.haveItem(4011000, 10) && cm.haveItem(4011001, 10) && cm.haveItem(4021010, 2) && cm.haveItem(4000463, 5) && cm.getMeso() >=10000000) {
                ...
                cm.sendOk("合成失败！材料不足！#v1113166#*1个 #v4001266#*200个 #v4000487#200个 #v4003002#20个 #v4003003#*20个 #v4001006#*50个 #v4031561#*10个 #v4031560#*10个 #v4011000#*10个 #v4011001#*10个 #v4021010#*2个 #v4000463#*5个+ 1000万金币");
                cm.dispose();
            }
        } else if (selection == 5) {
            if (cm.haveItem(1113167, 1) && cm.haveItem(4001266, 300) && cm.haveItem(4000487, 300) && cm.haveItem(4001006, 100) && cm.haveItem(4031561, 20) && cm.haveItem(4031560, 20) && cm.haveItem(4011000, 20) && cm.haveItem(4011001, 20) && cm.haveItem(4021010, 5) && cm.haveItem(4000257, 10) && cm.haveItem(4000463, 10) && cm.getMeso() >=30000000) {
                cm.gainItem(1113167,-1);
                ...
                cm.sendOk("合成失败！材料不足！#v1113167#*1个 #v4001266#*300个 #v4000487#*300个 #v4001006#*100个 #v4031561#*20个 #v4031560#*20个 #v4011000#*20个 #v4011001#*20个 #v4021010#*5个 #v4000257#*10个 #v4000463#*10个+ 3000万金币");
                cm.dispose();
            }
        } else if (selection == 6) {
