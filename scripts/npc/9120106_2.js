...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendSimple("#v3994071##v3994059##v3994061##v3994066##v3994067# PY交易中心\r\n#b#L1#购买#v4170005#1个：680点卷#l\r\n\r\n#b#L2#购买#v4170005#10张：6000点卷#l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("确定要使用 #b#t5150040##k 随机剪发了？？");
			...
			if(cm.getPlayer().getCSPoints(1) >= 680){
				cm.gainDJ(-680);
				cm.gainItem(4170005, 1);
				cm.sendOk("购买成功！");
				cm.worldMessage(6,"玩家：["+cm.getName()+"]购买了1 个飞天猪的蛋！(购买地点：自由市场)");
				cm.dispose();
			}else{
				cm.sendOk("点卷不足无法购买！");
				cm.dispose();
			...
			if(cm.getPlayer().getCSPoints(1) >= 6000){
				...
				cm.sendOk("购买成功！");
				cm.worldMessage(6,"玩家：["+cm.getName()+"]购买了10张飞天猪的蛋！(购买地点：自由市场)");
				cm.dispose();
			}else{
				cm.sendOk("点卷不足无法购买！");
				cm.dispose();
