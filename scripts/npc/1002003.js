...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendYesNo("我希望我能尽可能昨天...嗯，你好！难道你不希望扩充你的好友列表？你看起来像有人谁就会有一大堆的朋友......好了，你有什么感想？随着一些钱，我可以做到这一点你。但要记住，它仅适用于一个角色，所以不会影响您的任何其他角色在您的账号。你想扩充您的好友列表？");
    } else if (status == 1) {
	cm.sendYesNo("好吧！这并不是说贵实际。 #b250,000金币，我会添加5个空间到你的好友列表#k中。不，我不会单独出售。一旦你购买它，这将是永久你的好友列表上。所以，如果你是那些需要更多的空间有一个，那么你还不如去做。你怎么看？你会花25万金币吗？");
    } else if (status == 2) {
