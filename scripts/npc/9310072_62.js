...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112777#B级（四维+7 攻击+5 魔力+8 HP+300）\r\n      需要以下材料:\r\n ";
			text +="     请先把#v1112778#卸下放在背包里\r\n";
			text +="  #v4011005#15个 #v4021006#15个 #v4021007#15个 #v4005003#8个\r\n";
		...
		var type = ii.getInventoryType(1112777); //获得装备的类形
		var toDrop = ii.randomizeStats(ii.getEquipById(1112777)).copy(); // 生成一个Equip类
		//toDrop. setFlag(1);//上锁
		toDrop. setStr(7);//给力量
		toDrop. setDex(7);//给敏捷 
		toDrop. setInt(7);//给智力
