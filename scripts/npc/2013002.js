...
var itemList = new Array(
                         2100001,2100002,2100003,2100004,2100005,2100006,2100007,2100017,2100018,2100019,2044702,2044701,2044602,
                         ...
                         2043101,2043002,2043001,2040801,2040814,2040815,2040816,2040817,2040802,2040915,2040914,2040805,2040803,2040804,2040532,2040534,2040517,2040516,
                         2040514,2040513,2040502,2040501,2040323,2040321,2040317,2040316,2040302,2040301,1072455,4004004, //1x use items
                         4003000,
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
			...
			cm.gainItem(4001158, 1);//污染石头  给指定物品
			cm.gainItem(4002002, 1);//污染石头  给指定物品
