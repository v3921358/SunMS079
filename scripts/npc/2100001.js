...
function action(mode, type, selection) {
    if (mode == 1)
        ...
        cm.dispose();
    if (status == 0) {
        var selStr = "我喜欢你的态度！,我只跟年轻人打交道!你喜欢什么样的矿石提炼?#b";
        var options = new Array("提炼矿石", "提炼宝石矿", "水晶");
        ...
        var prompt = "所以你要制作 #t" + item + "# 。你想要做多少个呢？";
        ...
        prompt += " 在这种情况下，我会为了让需要你的具体物品。请确保您有足够的空间在您的背包！#b";
