...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        var options = new Array("制作战士手套", "制作弓箭手手套", "制作法师手套", "制作飞侠手套");
        ...
        if (selectedType == 0) { //warrior glove
            ...
            var selStr = "需要什么吗？？#b";
            var gloves = new Array("#t1082095##k - 飞侠 等级. 70#b", "#t1082096##k - 飞侠 等级. 70#b", "#t1082097##k - 飞侠 等级. 70#b",
                    "#t1082118##k - 飞侠 等级. 80#b", "#t1082119##k - 飞侠 等级. 80#b", "#t1082120##k - 飞侠 等级. 80#b");
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
