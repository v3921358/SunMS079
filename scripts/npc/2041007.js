...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendSimple("欢迎~欢迎 来到玩具城美发店!如果你有#b#t5150007##k或者#b#t5151007##k?我就可以帮你改变请选择要哪种服务: \r\n#L0#使用: #i5150007##t5150007##l\r\n#L1#使用: #i5151007##t5151007##l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.askAvatar("选择一个你喜欢的",hair_Colo_new);
	} else if (selection == 1) {
	...
	if (beauty == 1){
		...
		cm.sendOk("啊..貌似没有#t5150007#");
	    }
	} else {
	    if (cm.setAvatar(5151007, hair_Colo_new[selection]) == 1) {
		cm.sendOk("享受!");
	    } else {
		cm.sendOk("啊..貌似没有#t5151007#");
	    }
	}
	cm.dispose();
    }
