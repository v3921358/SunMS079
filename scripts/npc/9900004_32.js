...
//}		
            ...
            text += "#d欢迎来到转职服务\r\n\r\n"
			text += "#k#L1##e游戏转职#l       #L2##e技能全满#r#k#l"//3（2万点卷）

            cm.sendSimple(text);
        } else if (selection == 1) {
                cm.openNpc(9900004, 31);//游戏转职
        } else if (selection == 2) {
			if (cm.getPlayer().getCSPoints(1) >= 0) {//技能全满
				//cm.gainD(-0);
				cm.gainItem(5030001,1,1);//精灵店铺
		        cm.teachSkill(1003,1,1);//
				cm.teachSkill(1004,1,1);
				cm.teachSkill(1005,1,1);
				//cm.teachSkill(20000024,0,0);
				//cm.teachSkill(10000024,0,0);
				cm.teachSkill(20000012,0,0);
				//cm.teachSkill(10000012,0,0);
				 //cm.teachSkill(8,0,0);
				cm.teachSkill(12,0,0);
				 //cm.teachSkill(0008,0,0);
				 //cm.teachSkill(10000012,0,0);
				//cm.teachSkill(10000008,0,0);
                cm.teachSkill(0000008,0,0);
				//cm.teachSkill(12,0,0);
				...
				cm.teachSkill(2311002,30,30);   //时空门
 ...
 //炎术士
                ...
                cm.sendOk("您已成功激活了所有技能。");
				cm.dispose();
        } else if (selection == 5) { //属性重置
            cm.openNpc(9900004, 73);
        } else if (selection == 6) {//技能清空
            cm.teachSkill(1003,1,1);
				cm.teachSkill(1004,1,1);
				cm.teachSkill(1005,1,1);
				cm.teachSkill(20000024,0,0);
				...
				cm.teachSkill(21110008,0,20); //全力挥击
				cm.teachSkill(21121000,0,30); //冒险岛勇士
				cm.teachSkill(21120001,0,30); //攻击策略
				cm.teachSkill(21120002,0,30); //战神之舞
				cm.teachSkill(21121003,0,30); //战神的意志
				...
				cm.teachSkill(4000001,0,8); //End of max-level "8" skills
				cm.teachSkill(1000001,0,10); //Start of max-level "10" skills
				cm.teachSkill(2000001,0,10); //End of max-level "10" skills
				cm.teachSkill(1000000,16,16); //Start of max-level "16" skills
				cm.teachSkill(2000000,16,16);
				cm.teachSkill(3000000,16,16); //End of max-level "16" skills
				cm.teachSkill(1001003,0,20); //Start of max-level "20" skills
				cm.teachSkill(3200001,0,30);
				cm.teachSkill(1001004,0,20);
				cm.teachSkill(1001005,0,20);
				cm.teachSkill(2001002,0,20);
				cm.teachSkill(2001003,0,20);
				cm.teachSkill(2001004,0,20);
				cm.teachSkill(2001005,0,20);
				cm.teachSkill(3000001,0,20);
				cm.teachSkill(3001003,0,20);
				...
				cm.teachSkill(4001003,0,20);
				cm.teachSkill(1101005,0,20);
				cm.teachSkill(1100001,0,20); //Start of mastery's
				cm.teachSkill(1100000,0,20);
				cm.teachSkill(1200001,0,20);
				cm.teachSkill(1200000,0,20);
				cm.teachSkill(1300000,0,20);
				cm.teachSkill(1300001,0,20);
				...
				cm.teachSkill(2101001,0,20);
				cm.teachSkill(2100000,0,20);
				cm.teachSkill(2101003,0,20);
				cm.teachSkill(2101002,0,20);
				cm.teachSkill(2201001,0,20);
				cm.teachSkill(2200000,0,20);
				cm.teachSkill(2201003,0,20);
				cm.teachSkill(2201002,0,20);
				cm.teachSkill(2301004,0,20);
				cm.teachSkill(2301003,0,20);
				cm.teachSkill(2300000,0,20);
				cm.teachSkill(2301001,0,20);
				cm.teachSkill(3101003,0,20);
				cm.teachSkill(3101004,0,20);
				cm.teachSkill(3201003,0,20);
				cm.teachSkill(3201004,0,20);
				cm.teachSkill(4100002,0,20);
				cm.teachSkill(4101004,0,20);
				cm.teachSkill(4200001,0,20);
				cm.teachSkill(4201003,0,20); //End of second-job skills and first-job
				cm.teachSkill(4211005,0,20);
				cm.teachSkill(4211003,0,20);
				cm.teachSkill(4210000,0,20);
				cm.teachSkill(4110000,0,20);
				cm.teachSkill(4111001,0,20);
				cm.teachSkill(4111003,0,20);
				cm.teachSkill(3210000,0,20);
				cm.teachSkill(3110000,0,20);
				cm.teachSkill(3210001,0,20);
				cm.teachSkill(3110001,0,20);
				...
				cm.teachSkill(5001001,0,20); //Flash Fist
				cm.teachSkill(5001002,0,20); //Sommersault Kick
				cm.teachSkill(5001003,0,20); //Double Shot
				cm.teachSkill(5001005,0,10); //Dash
				cm.teachSkill(5100000,0,10); //Improve MaxHP
				cm.teachSkill(5100001,0,20); //Knuckler Mastery
				cm.teachSkill(5101002,0,20); //Backspin Blow
				cm.teachSkill(5101003,0,20); //Double Uppercut
				...
				cm.teachSkill(5201001,0,20); //Invisible Shot
				cm.teachSkill(5201002,0,20); //Grenade
				cm.teachSkill(5201003,0,20); //Gun Booster
				...
				cm.teachSkill(5211001,0,30); //Octopus
				...
				cm.teachSkill(5121001,0,30); //Dragon Strike
				cm.teachSkill(5121002,0,30); //Energy Orb
				cm.teachSkill(5121003,0,20); //Super Transformation
				...
				cm.teachSkill(5121008,0,30);   //Pirate's Rage
				cm.teachSkill(5121009,0,20); //Speed Infusion
				cm.teachSkill(5121010,0,30); //Time Leap
				...
				cm.teachSkill(5221008,0,30); //BattleShop Torpedo
 ...
 //炎术士
				...
				cm.teachSkill(12001001,0,10); //魔法盾
				cm.teachSkill(12001002,0,10); //魔法铠甲
				cm.teachSkill(12001003,0,20); //魔法双击
				cm.teachSkill(12001004,0,20); //炎精灵
				cm.teachSkill(12101000,0,20); //精神力
				cm.teachSkill(12101001,0,20); //缓速术
				cm.teachSkill(12101002,0,20); //火焰箭
				cm.teachSkill(12101003,0,20); //快速移动
				...
				cm.teachSkill(12110001,0,20); //魔力激化
				cm.teachSkill(12111002,0,20); //封印术
				cm.teachSkill(12111003,0,20); //天降落星
				...
				cm.teachSkill(13111001,0,30); //箭扫射
				cm.teachSkill(13111002,0,20); //暴风箭雨
				cm.teachSkill(13110003,0,20); //神箭手
				...
				cm.teachSkill(14111001,0,20); //影网术
				cm.teachSkill(14111002,0,30); //多重飞镖
				cm.teachSkill(14110003,0,20); //药剂精通
				...
				cm.teachSkill(15111001,0,20); //能量耗转
				cm.teachSkill(15111002,0,10); //超人变形
				cm.teachSkill(15111003,0,20); //碎石乱击
				...
				cm.openNpc(9900005, 3);//游戏转生
        } else if (selection == 4) {
				cm.openNpc(9900005, 4);//属性点重置
				//cm.dispose();
	}
    }
}
