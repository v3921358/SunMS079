...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendSimple("#v4000423##v3994077##v3994079##v3994076##v3994074##v3994076##v3994067##v3994077##v3994063##v4000422#\r\n#v4000424##n迎春节,精彩纷呈.#v4000425#\r\n\r\n#b#L1#购买#v5220000#1个：300点卷#l\r\n#b#L2#购买#v5220000#10个：2800点卷#l");
    } else if (status == 1) {
	if (selection == 0) {
	    ...
	    cm.sendYesNo("确定要使用 #b#t5150040##k 随机剪发了？？");
			...
			if(cm.getPlayer().getCSPoints(1) >= 300){
				...
				cm.sendOk("购买成功！");
//				cm.worldMessage(6,"玩家：["+cm.getName()+"]购买了1张皇家理发卷！(购买地点：射手村理发店)");
				cm.dispose();
			}else{
				cm.sendOk("点卷不足无法购买！");
				cm.dispose();
			...
			if(cm.getPlayer().getCSPoints(1) >= 2800){
				cm.gainDJ(-2800);
				cm.gainItem(5220000, 10);
				cm.sendOk("购买成功！");
//				cm.worldMessage(6,"玩家：["+cm.getName()+"]购买了10张皇家理发卷！(购买地点：射手村理发店)");
				cm.dispose();
			}else{
				cm.sendOk("点卷不足无法购买！");
				cm.dispose();
