...
function start()
{
	cm.sendSimple("你现在是#r高级玩家#k啦，带新人完成副本任务可以奖励你一个#b旅行者纪念币#k.凑齐#b25#k个找我兑换你想要的奖励吧！\r\n#L0##b使用25个#v4000463# 兑换 #v2048010# #k#l\r\n#L1##b使用25个#v4000463# 兑换 #v2048011# #k#l\r\n#L2##b使用25个#v4000463# 兑换 #v2048012# #k#l\r\n#L3##b使用25个#v4000463# 兑换 #v2048013# #k#l");
...
function action(mode, type, selection) {
	if(selection == 0)
	{
		...
		{
			cm.sendOk("很可惜哦, 你并没有#b25#k个#v4000463#.");
			cm.dispose();
			return;
		}
	...
	else if(selection == 1)
	{
		if(!cm.haveItem(4000463, 25))
		{
			cm.sendOk("很可惜哦, 你并没有#b10#k个#v4000463#.");
			cm.dispose();
			return;
		}
