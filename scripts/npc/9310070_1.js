...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text +="  #v4021009#1个   #v4011007#1个  #v4032391#5个   #v4032392#5个  #v4032393#5个\r\n";
			text +="  #v4031560#10个  #v4031561#5个  #v4000040#1个  #v4000176#1个  #v2210006#1个\r\n\r\n";
			text +="                  合成费用：1,000,000金币（一百万）\r\n";
			text += "                                    #L1##r我要合成\r\n";
			
            cm.sendSimple(text);
        } else if (selection == 1) {
            if (cm.haveItem(4021009, 1) && cm.haveItem(4011007, 1) && cm.haveItem(4032391, 5) && cm.haveItem(4032392, 5) && cm.haveItem(4032393, 5) && cm.haveItem(4031560, 10) && cm.haveItem(4031561, 5) && cm.haveItem(4000040, 1) && cm.haveItem(4000176, 1) && cm.haveItem(2210006, 1) &&cm.getMeso() >=1000000) {
