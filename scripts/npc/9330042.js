...
function action(mode, type, selection) {
	...
	if (cm.haveItem(5310000)) {
	    cm.sendYesNo("你有一些 #b#t5310000##k\r\n你想要尝试运气?御守是随机抽出的.\r\n#v2022216##z2022216# #v2022219##z2022219# #v2022222##z2022222# #v2022223##z2022223#");
	} else {
	    cm.sendOk("很抱歉由于你没有#b#t5310000##k所以不能尝试在我这里如果你的运气足够好就能获得#v2022219##v2022221##v2022223#。。");
	    cm.safeDispose();
	}
    } else if (status == 1) {
	var item;
	if (Math.floor(Math.random() * 300) == 0) {
	    var rareList = new Array(2022219, 2022216, 2022223);
	    ...
	    var itemList = new Array(2022216, 2022223, 2022219);
