...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112657#（四维+3）需要以下材料:\r\n";
			text +="      请先把#v1112793#卸下放在背包里\r\n";
			text +="  #v4011007#5个   #v4021007#7个  #v4021008#7个  #v4000040#3个  #v4000176#3个\r\n";
			text +="  #v4021000#7个   #v4021001#7个  #v4021002#7个   #v4021003#7个  #v4021004#7个\r\n";
			text +="  #v4021005#7个   #v4021006#7个   #v4031561#7个   #v4031560#7个   #v4031559#7个\r\n\r\n";
			text +="                  合成费用：1,800,000金币（一百八十万）\r\n";
			text += "                                    #L1##r我要合成\r\n";
		...
		var type = ii.getInventoryType(1112657); //获得装备的类形
		var toDrop = ii.randomizeStats(ii.getEquipById(1112657)).copy(); // 生成一个Equip类
		//toDrop. setFlag(1);//上锁
		toDrop. setStr(3);//给力量
		toDrop. setDex(3);//给敏捷 
		toDrop. setInt(3);//给智力
