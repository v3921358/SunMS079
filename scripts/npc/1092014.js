 ...
 */
var status = 0;
var maps = Array(104000000, 102000000, 101000000, 103000000, 100000000);
...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	cm.sendNext("您好~! 诺特勒斯计程车. 想要往其他村庄安全又快速的移动吗? 如果是这样 为了优先考虑满足顾客, 请使用 #b#p1092014##k 亲切的送你到想要到达的地方！");
    } else if (status == 1) {
	var job = cm.getJob();
