...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112768#A级（四维+10 攻击+10 魔力+15 HP+600）\r\n      需要以下材料:\r\n ";
			text +="     请先把#v1112769#卸下放在背包里\r\n";
			text +="  #v4011002#25个 #v4021000#25个 #v4021001#25个 #v4005000#15个\r\n";
