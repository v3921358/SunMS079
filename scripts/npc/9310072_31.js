...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112770#C级（四维+5 攻击+2 魔力+4 hp+120）\r\n      需要以下材料:\r\n ";
			text +="     请先把#v1112657#卸下放在背包里\r\n";
			text +="  #v4011002#10个 #v4021000#10个 #v4021001#10个 #v4005000#5个\r\n";
            ...
            if (cm.haveItem(1112657, 1) && cm.haveItem(4011002, 10) && cm.haveItem(4021000, 10) && cm.haveItem(4021001, 10) && cm.haveItem(4005000, 5) && cm.haveItem(4021008, 10) && cm.haveItem(4005004, 5) && cm.haveItem(4021009, 5) && cm.haveItem(4011007, 5) && cm.haveItem(4003000, 200) && cm.haveItem(4031560, 10) && cm.haveItem(4031559, 15) && cm.haveItem(4031561, 5) && cm.haveItem(4032391, 5) && cm.haveItem(4032392, 5) && cm.getMeso() >=2000000) {
		...
		var type = ii.getInventoryType(1112770); //获得装备的类形
		var toDrop = ii.randomizeStats(ii.getEquipById(1112770)).copy(); // 生成一个Equip类
		//toDrop. setFlag(1);//上锁
		toDrop. setStr(5);//给力量
		toDrop. setDex(5);//给敏捷 
		toDrop. setInt(5);//给智力
