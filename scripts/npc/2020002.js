...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        if (selectedType == 0) { //warrior shoes
            ...
            selStr = "需要什么吗？？#b";
            var shoes = new Array("#t1072150##k - 飞侠 等级. 60#b", "#t1072151##k - 飞侠 等级. 60#b", "#t1072152##k - 飞侠 等级. 60#b",
                    "#t1072161##k - 飞侠 等级. 70#b", "#t1072162##k - 飞侠 等级. 70#b", "#t1072163##k - 飞侠 等级. 70#b",
                    "#t1072172##k - 飞侠 等级. 80#b", "#t1072173##k - 飞侠 等级. 80#b", "#t1072174##k - 飞侠 等级. 80#b");
        }
        ...
        var prompt = "你想要制作 #t" + item + "#? 在这种情况下, 我为了要做出最棒的品质，我建议你确保装备栏空间足够。#b";
