...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var options = new Array("什么是辅助剂?", "制作战士鞋子", "制作弓箭手鞋子", "制作法师鞋子", "制作飞侠鞋子",
                "制作战士鞋子使用辅助剂", "制作弓箭手鞋子使用辅助剂", "制作法师鞋子使用辅助剂", "制作=飞侠鞋子使用辅助剂");
        ...
        if (selectedType == 0) { // what is stim
            cm.sendNext("辅助剂是一种特殊的药水，我可以加入到创建某些物品中。它给它统计中，就好像从一个怪物下降。然而，它可能有没有变化，而且也有可能为物品于平均水平。还有没有得到任何物品使用刺激的时候，所以请明智的选择有10％的机会。");
            cm.dispose();
            return;
        }
        if (selectedType == 1) { //warrior shoe
            selStr = "很好，那么你想做哪一个？？#b";
            shoes = new Array("#t1072003##k - 战士 等级. 30#b", "#t1072039##k - 战士 等级. 30#b", "#t1072040##k - 战士 等级. 30#b", "#t1072041##k - 战士 等级. 30#b",
                    "#t1072002##k - 战士 等级. 35#b", "#t1072112##k - 战士 等级. 35#b", "#t1072113##k - 战士 等级. 35#b",
                    "#t1072000##k - 战士 等级. 40#b", "#t1072126##k - 战士 等级. 40#b", "#t1072127##k - 战士 等级. 40#b",
                    "#t1072132##k - 战士 等级. 50#b", "#t1072133##k - 战士 等级. 50#b", "#t1072134##k - 战士 等级. 50#b", "#t1072135##k - 战士 等级. 50#b");
            ;
            ...
            selStr = "很好，那么你想做哪一个？？#b";
            shoes = new Array("#t1072032##k - 飞侠 等级. 30#b", "#t1072033##k - 飞侠 等级. 30#b", "#t1072035##k - 飞侠 等级. 30#b", "#t1072036##k - 飞侠 等级. 30#b",
        ...
        if (!complete)
            ...
            if (stimulator) { //check for stimulator
                ...
                if (deleted != 0) {
                    ...
                    cm.sendOk("不幸的是，辅助剂...抵触你的鞋子。我很抱歉是我的失误.....");
                }
