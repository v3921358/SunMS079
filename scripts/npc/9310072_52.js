...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112773#B级（四维+7 攻击+5 魔力+8 命中+30）\r\n      需要以下材料:\r\n ";
			text +="     请先把#v1112774#卸下放在背包里\r\n";
			text +="  #v4011004#15个 #v4021004#15个 #v4021005#15个 #v4005002#8个\r\n";
			text +="  #v4021008#10个  #v4005004#5个 #v4021009#8个 #v4011007#8个 #v4003000#500个 \r\n";
			text +="  #v4031560#25个 #v4031559#15个  #v4031561#10个 #v4032392#8个 #v4032393#8个\r\n";
            ...
            if (cm.haveItem(1112774, 1) && cm.haveItem(4000021, 100) && cm.haveItem(4000030, 50) && cm.haveItem(4011004, 15) && cm.haveItem(4021004, 15) && cm.haveItem(4021005, 15) && cm.haveItem(4005002, 5) && cm.haveItem(4021008, 10) && cm.haveItem(4005004, 5) && cm.haveItem(4021009, 8) && cm.haveItem(4011007, 8) && cm.haveItem(4003000, 500) && cm.haveItem(4031560, 25) && cm.haveItem(4031559, 15) && cm.haveItem(4031561, 10) && cm.haveItem(4032392, 8) && cm.haveItem(4032392, 8) && cm.getMeso() >=2800000) {
                cm.gainItem(1112774,-1);
				cm.gainItem(4000021,-100);
				cm.gainItem(4000030,-50);
				cm.gainItem(4011004,-15);
				cm.gainItem(4021004,-15);
				cm.gainItem(4021005,-15);
				cm.gainItem(4005002,-8);
		...
		var type = ii.getInventoryType(1112773); //获得装备的类形
		var toDrop = ii.randomizeStats(ii.getEquipById(1112773)).copy(); // 生成一个Equip类
		//toDrop. setFlag(1);//上锁
		toDrop. setStr(7);//给力量
		toDrop. setDex(7);//给敏捷 
		toDrop. setInt(7);//给智力
