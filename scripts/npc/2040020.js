...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var options = new Array("什么是催化剂?", "做一双战士手套", "做一双弓箭手手套", "做一双法师手套", "做一双飞侠手套",
                "做一双战士手套使用催化剂", "做一双弓箭手手套使用催化剂", "做一双法师手套使用催化剂", "做一双飞侠手套使用催化剂");
        ...
        if (selectedType == 0) { //What's a stim?
            ...
            var selStr = "很好，那么你想做哪一个？？#b";
            var gloves = new Array("#t1082042##k - 飞侠 等级. 30#b", "#t1082046##k - 飞侠 等级. 35#b", "#t1082075##k - 飞侠 等级. 40#b", "#t1082065##k - 飞侠 等级. 50#b");
            ...
            var selStr = "很好，那么你想做哪一个？？#b";
            var gloves = new Array("#t1082043##k - 飞侠 等级. 30#b", "#t1082044##k - 飞侠 等级. 30#b", "#t1082047##k - 飞侠 等级. 35#b", "#t1082045##k - 飞侠 等级. 35#b", "#t1082076##k - 飞侠 等级. 40#b",
                    "#t1082074##k - 飞侠 等级. 40#b", "#t1082067##k - 飞侠 等级. 50#b", "#t1082066##k - 飞侠 等级. 50#b");
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
