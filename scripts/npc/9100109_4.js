...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#r需要材料#k 30张#v4002000#,30张#v4002001#,#v4000017#20个,#v2140001#150万\r\n"//1
            text += "#L1#兑换#v1122007##z1122007# #l\r\n\r\n"//1
			text += "#L2#10张#v4002000#兑换#v2041211##z2041211# #l"//1
		   ...
		   cm.dispose();
           	   ...
           	   if (cm.haveItem(4002000, 30)&&cm.haveItem(4002001, 30)&&cm.haveItem(4000017, 20)&&cm.getMeso() >= 1500000) { 
                   ...
                   cm.sendOk("兑换成功!");
cm.worldMessage(6,"恭喜[ " + cm.getPlayer().getName() + "] 成功兑换休彼德蔓的项链!");				   
                   cm.dispose();
                   } else {
