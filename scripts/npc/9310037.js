...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	cm.sendNext("嗨, 我是#p9310037# 如果你有一张 #b#t5152043##k, 我可以帮你随机整形！");
    } else if (status == 1) {
	cm.sendYesNo("你确定要使用 #b#t5152043##k?");
    } else if (status == 2){
	...
	if (cm.setRandomAvatar(5152043, facetype) == 1) {
	    cm.sendOk("享受!");
	} else {
	    cm.sendOk("你好像没有#t5152043#");
	}
	cm.dispose();
    }
}