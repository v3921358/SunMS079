...
function action(mode, type, selection) {
	...
	if (selection == 0) {
		...
		hair_Colo_new = [30310, 30330, 30060, 30150, 30410, 30210, 30140, 30120, 30200, 30560, 30510, 30610, 30470,30800];
	    } else {
	...
	if (beauty == 1){
		...
		cm.sendOk("啊.... 貌似没有#b#t5150000##k。");
	    }
	} else {
	    if (cm.setRandomAvatar(5151000, hair_Colo_new) == 1) {
		cm.sendOk("查看你的新发型吧！");
	    } else {
		cm.sendOk("啊.... 貌似没有#b#t5151000##k。");
	    }
	}
	cm.safeDispose();
    }
