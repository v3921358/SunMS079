 ...
 */
var status = 0;
var maps = Array(104000000, 102000000, 101000000, 103000000, 120000000, 100000000);
var rCost = Array(1200, 1000, 800, 1000, 1000 ,1000);
var costBeginner = Array(120, 100, 80, 100, 100,100);
var cost = new Array("1,200", "1,000", "800", "1,000", "1,000" ,"1,000");
var show;
var sCost;
var selectedMap = -1;
...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	cm.sendNext("您好~! 明珠港计程车. 想要往其他村庄安全又快速的移动吗? 如果是这样 为了优先考虑满足顾客, 请使用 #b#p1002007##k 亲切的送你到想要到达的地方！");
    } else if (status == 1) {
	var job = cm.getJob();
