...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendSimple("嗨，我是#p2100005# 如果你有 #b#t5150026##k 或者 #b#t5151021##k 就可以来找我！ 选择一个服务: \r\n#L0#使用:#b#t5150026##k \r\n#L1#使用:#b#t5151021##k");
		} else if (status == 1) {
			if (selection == 0) {
				beauty = 1;
				hairnew = Array();
