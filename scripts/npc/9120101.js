...
function action(mode, type, selection) {
	...
	if (selection == 0) {
		...
		hair_Colo_new = [30230, 30260, 30280, 30240, 30290, 30020, 30270, 30340,30810];
	    } else {
	    ...
	    cm.sendYesNo("是否要使用 #b#t5150008##k 来随机？？");
	    ...
	    cm.sendYesNo("是否要使用 #b#t5151008##k 来随机？？");
	}
    } else if (status == 2){
	if (beauty == 1){
