...
function action(mode, type, selection) {
	...
	cm.sendNext("嘿,你想跟我互换东西？好了，我的工作就是在这里收集物品然后在其他地方出售，但是这些天怪物变得更加顽劣，所以它很难获得良好的道具...你想要做一些东西吗？");
    } else if (status == 1) {
	...
	if(!cm.haveItem(requiredItem,100)){
	    cm.sendOk("嗯... 你确定你有 #b100个 #t" + requiredItem + "##k? 如果有请定你道具栏是不是满了....");
	} else if(!cm.canHold(prizeItem)){
	    cm.sendNext("你的道具栏满了，请清空一些不要的东西再来找我交易一次谢谢。");
	} else {
	    cm.gainItem(requiredItem,-100);
	    cm.gainExp(500);
	    cm.gainItem(prizeItem, prizeQuantity);
	    cm.sendOk("为你的 #b100个 #t"+requiredItem+"##k, 这里是我的奖励 #b"+prizeQuantity+" #t"+prizeItem+"##k.怎么样喜欢我给你的东西吗？\r\n如果喜欢.欢迎下次再来找我交易，我会在这里等着你的！！");
	}
	cm.dispose();
    }
}
