	...
	return;
        ...
        if (status == 0) {
            if (cm.getParty() == null) { // No Party
                cm.sendSimple("How about you and your 队员 collectively beating a quest? Here you'll find obstacles and problems where you won't be able to beat it unless with great teamwork. If you want to try it, please tell the #bleader of your party#k to talk to me.\r\n\r\n#rRequirements: " + minPartySize + " 队员, all between level " + minLevel + " and level " + maxLevel + ".");
