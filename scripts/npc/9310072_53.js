...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text +="      #r升级#v1112772#A级（四维+10 攻击+10 魔力+15 命中+50）\r\n      需要以下材料:\r\n ";
			text +="     请先把#v1112773#卸下放在背包里\r\n";
			text +="  #v4011004#25个 #v4021004#25个 #v4021005#25个 #v4005002#15个\r\n";
			text +="  #v4021008#15个  #v4005004#8个 #v4021009#10个 #v4011007#10个 #v4003000#900个 \r\n";
			text +="  #v4031560#40个 #v4031559#30个  #v4031561#20个 #v4032392#10个 #v4032393#10个\r\n";
            ...
            if (cm.haveItem(1112773, 1) && cm.haveItem(4000176, 8) && cm.haveItem(4000040, 8) && cm.haveItem(4000021, 280) && cm.haveItem(4000030, 120) && cm.haveItem(4011004, 25) && cm.haveItem(4021004, 25) && cm.haveItem(4021005, 25) && cm.haveItem(4005002, 15) && cm.haveItem(4021008, 15) && cm.haveItem(4005004, 8) && cm.haveItem(4021009, 10) && cm.haveItem(4011007, 10) && cm.haveItem(4003000, 900) && cm.haveItem(4031560, 40) && cm.haveItem(4031559, 30) && cm.haveItem(4031561, 20) && cm.haveItem(4032392, 10) && cm.haveItem(4032393, 10) && cm.getMeso() >=3500000) {
                cm.gainItem(1112773,-1);
				cm.gainItem(4000176,-8);
				cm.gainItem(4000040,-8);
				cm.gainItem(4000021,-280);
				cm.gainItem(4000030,-120);
				cm.gainItem(4011004,-25);
				cm.gainItem(4021004,-25);
				cm.gainItem(4021005,-25);
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
            ...
            if (cm.haveItem(1113164, 1) && cm.haveItem(4001266, 50) && cm.haveItem(4000487, 50) && cm.haveItem(4031559, 5) && cm.haveItem(4003002, 5) && cm.haveItem(4003003, 5) && cm.haveItem(4000463, 1) && cm.haveItem(4021004, 10) && cm.haveItem(4021004, 10) && cm.haveItem(4021005, 10) && cm.haveItem(4021004, 10) && cm.haveItem(4021006, 10) && cm.getMeso() >=5000000) {
		...
		cm.getC().getSession().write(CWvsContext.InventoryPacket.addInventorySlot(type, toDrop, false)); //刷新背包
            ...
            if (cm.haveItem(1113166, 1) && cm.haveItem(4001266, 200) && cm.haveItem(4000487, 200) && cm.haveItem(4003002, 20) && cm.haveItem(4003003, 20) && cm.haveItem(4001006, 50) && cm.haveItem(4031561, 10) && cm.haveItem(4031560, 10) && cm.haveItem(4021004, 10) && cm.haveItem(4021005, 10) && cm.haveItem(4021010, 2) && cm.haveItem(4000463, 5) && cm.getMeso() >=10000000) {
            ...
            if (cm.haveItem(1113167, 1) && cm.haveItem(4001266, 700) && cm.haveItem(4000487, 700) && cm.haveItem(4001006, 100) && cm.haveItem(4031561, 20) && cm.haveItem(4031560, 20) && cm.haveItem(4021004, 20) && cm.haveItem(4021005, 20) && cm.haveItem(4021010, 5) && cm.haveItem(4000257, 10) && cm.haveItem(4000463, 10) && cm.getMeso() >=30000000) {
                cm.gainItem(1113167,-1);
            ...
            if (cm.haveItem(1112679, 7) && cm.haveItem(4000313, 1250) && cm.haveItem(4021004, 50) && cm.haveItem(4021007, 50) && cm.haveItem(4021006, 50) && cm.haveItem(4021005, 50) && cm.haveItem(4021004, 50) && cm.haveItem(4251202, 5) && cm.haveItem(4001083, 5) && cm.haveItem(4001084, 15) && cm.haveItem(4001085, 15) && cm.haveItem(4000175, 15) && cm.haveItem(4001126, 12500) && cm.haveItem(4000487, 100) && cm.haveItem(4002000, 500) && cm.haveItem(4002001, 75) && cm.haveItem(4002002, 25) && cm.haveItem(4002003, 90) && cm.haveItem(4031559, 50) && cm.getMeso() >=50000000) {
                ...
                cm.sendOk("合成失败！材料不足！#v4000313#*1250个 #v1112679#*7个 #v4021004#*50个  #v4021007#*50个   #v4021006#*50个   #v4021005#*50个  #v4021004#*50个   #v4251202#*5个 #v4001083#*5个 #v4001084#*15个 #v4001085#*15个 #v4000175#*15个  #v4001126#*12500个   #v4000487#*100个  #v4002000#*500个  #v4002001#*100个 #v4002002#*25个 #v4002003#*90个 #v4031559#*50个 5000万金币");
                cm.dispose();
            }
			        } else if (selection == 7) {
            if (cm.haveItem(1112679, 7) && cm.haveItem(4000313, 1250) && cm.haveItem(4021004, 50) && cm.haveItem(4021007, 50) && cm.haveItem(4021006, 50) && cm.haveItem(4021005, 50) && cm.haveItem(4021004, 50) && cm.haveItem(4251202, 5) && cm.haveItem(4001083, 5) && cm.haveItem(4001084, 15) && cm.haveItem(4001085, 15) && cm.haveItem(4000175, 15) && cm.haveItem(4001126, 12500) && cm.haveItem(4000487, 100) && cm.haveItem(4002000, 500) && cm.haveItem(4002001, 75) && cm.haveItem(4002002, 25) && cm.haveItem(4002003, 90) && cm.haveItem(4031559, 50) && cm.getMeso() >=50000000) {
