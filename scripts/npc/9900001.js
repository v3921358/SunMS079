...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            cm.dispose();
        } else if (selection == 2 && cm.getPlayerStat("ADMIN") == 0) {
            var avail = "";
            for (var i = -1; i > -199; i--) {
    ...
    } else if (status == 2 && cm.getPlayerStat("ADMIN") == 0) {
    ...
    } else if (status == 3 && cm.getPlayerStat("ADMIN") == 0) {
        statsSel = selection;
        if (selection == 22) {
    ...
    } else if (status == 4 && cm.getPlayerStat("ADMIN") == 0) {
    ...
    } else if (status == 10 && cm.getPlayerStat("ADMIN") == 0) {
