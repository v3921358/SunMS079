...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            gsjb +="#L3##b兑换点卷 #fUI/Basic/BtHide3/mouseOver/0# #b比例 - (#r2 = 1#b)#l\r\n";
			gsjb +="#L4##b兑换抵用卷 #fUI/Basic/BtHide3/mouseOver/0# #b比例 - (#r1 = 1#b)#l\r\n\r\n\r\n";
...
*/
                ...
                if (cm.haveItem(4001126, selection)) {
                    ...
                    cm.sendOk("您成功将#z4001126##v4001126# x #r" + selection + " #k换为#r " + Math.floor(1 * selection) + " #k抵用券。");
                } else {
                ...
                if (cm.haveItem(4001126, 2 * selection)) {
                    cm.gainItem(4001126, - (2 * selection));
                    cm.gainDJ(+Math.floor(1 * selection));
                    cm.sendOk("您成功将#z4001126##v4001126# x #r" + (2 * selection) + " #k换为#r " + Math.floor(1 * selection) + " #k点卷。");
                } else {
                    cm.sendNext("您的输入的数量错误，无法兑换抵用卷。");
                    cm.dispose();
                }
